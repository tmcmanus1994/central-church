  ...
  return (
    <div className="mx-auto max-w-[1100px] px-5 py-8 lg:px-14 lg:py-16">
      ...
      <Reveal className="mt-8 lg:mt-12">
        <Link
          href={`/blog/${lead.slug}`}
          className="flex flex-col gap-5 rounded-2xl border border-line p-4 text-ink no-underline transition-colors hover:border-teal-border hover:bg-teal-50/40 lg:flex-row lg:items-center lg:gap-8 lg:p-6"
        >
          <ImageSlot
